...
def get_datasets():
    ...
    dataset_name = h.fixed("dataset", "dsprites-color-white")
...
def get_config_postprocess():
    ...
    factors_idx = h.fixed("factor_idx_process", list(range(1, 6)))
...
class WHITECOLORDSPRITES(Experiment):

    def __init__(self):
        super(WHITECOLORDSPRITES, self).__init__()
