...
def get_datasets():
    ...
    dataset_name = h.fixed("dataset", "rgbd_objects")
...
def get_default_models():
    ...
    warm_up = h.fixed("warm_up_iterations", 0) # ignored
...
def get_config_postprocess():
    ...
    factors_idx = h.fixed("factor_idx_process", [0, 2, 3]) # no instance class
