...
def main(unused_args):
    ...
    alpha = 1.0 # considering only the overalp_score which is the Modularity
    gamma = True
    ...
    to_latex.style.hide(axis="index").to_latex(os.path.join(output_directory, "improvement.tex")) #  , index=False, float_format="%.3f"
